...
Label(root, text = "LANGUAGE TRANSLATOR FROM ONE LANGUAGE TO ANOTHER LANGUAGE", font = "arial 15 bold", fg='black', bg='white').pack()
Label(root,text ="Ravi's Translator", font = 'arial 16', fg='black', bg='gray' , height = '5', width = '20').pack(side = 'bottom')
